 ...
 * remove a character, or replace a character. Given two strings, write a function to check if they are one
...
/** This algorithm(and almost any reasonable algorithm) takesO(n) time,where n is the length of the shorter string. */
...
public class OneEditAway {
    ...
    static boolean oneEditAway(String first, String second) {
        ...
        else if(first.length() - 1 == second.length()) return oneEditAway(second, first);
    ...
    /** oneEditInsert : check if you can insert or remove a character in s1 to make s2 */
